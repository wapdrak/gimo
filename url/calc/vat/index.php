...
<label for="novat">
		...
		<input oninput="sumTotal()" type="number" name="novat" id="novat" class="border4px bordergroove borderblack radius10px">
		<br>
		
<label for="vat">
        &nbsp;&nbsp;מחיר כולל מע"מ:&nbsp;&nbsp;
</label>
		<input oninput="sumnovat()" type="number" name="vat" id="vat" class="border4px bordergroove borderblack radius10px">
