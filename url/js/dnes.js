...
function acas() {
    ...
    var sden = new Array("neděle", "pondělí", "úterý", "středa", "čtvrtek", "pátek", "sobota");
    var smesic = new Array("ledna", "února", "března", "dubna", "května", "června", "července", "srpna", "září", "října", "listopadu", "prosince");
    var jom = new Array("Rišon", "Šeni", "Šliši", "Revii", "Chamiši", "Šiši", "Šabat -Šábes");
    ...
    dnes += smesic[mesic] + "(";
    dnes += 1 + mesic + "),</b> ";
    dnes += "týden č. <b>" + ctydnu + "</b>, ";
    dnes += "rok <b>" + rok + "</b>, ";
    dnes += "přesný čas: <b>" + pcas + "</b>, ";
    ...
    document.getElementById("hajom").innerHTML = "Hebrejské datum : <b>Jom " + hajom + "</b>";

    if (svatky[mesic][ddatum - 1] != " ") document.getElementById("svdnes").innerHTML = "svátek má <b>" + svatky[mesic][ddatum - 1] + "</b>, zítra <b>" + svatky[mesic][ddatum - 0] + "</b>";
