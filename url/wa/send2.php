...
<title>&#128488; שליחת הודעות ואטסאפ לכול מספר בלי לשמור אותו בספר טלפונים | גימו בע"מ | ציוד משרדי | חותמות במקום</title>
...
<script>
   function wa(width, height){
var left = (screen.width / 2) - (width / 2);
var top = (screen.height / 2) - (height / 2);
	   
var uri = "https://wa.me/<?php $wa = $_GET['n']; echo '. $wa'; ?>?text=<?php $text = $_GET['t']; echo '. $text'; ?>";
