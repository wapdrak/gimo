...
$.alert({
    ...
    useBootstrap: false,
    theme: 'supervan',
    content: 'url:/cs/reklama/share.html',
    buttons: {
        ok: {
            text: 'Zavřít',
...
var url = uri + href1 + encodeURIComponent(desc) + href4 + encodeURIComponent(title) + title2 + encodeURIComponent(href);
...
var uri = "https://www.stumbleupon.com/submit?";
...
var uri = "https://compose.mail.yahoo.com/?";
...
var uri = "https://widget.renren.com/dialog/share?";
...
var uri = "https://service.weibo.com/share/share.php?";
...
var left = (screen.width / 2) - (width / 2);
var top = (screen.height / 2) - (height / 2);
var url = "https://surfingbird.ru/share?url="+encodeURIComponent(location.href)+"&description=&screenshot=&title="+encodeURIComponent(document.title);
window.open(url,'_blank','scrollbars=yes,toolbar=yes,location=yes,directories=yes,status=yes,resizable=yes,width='+width+',height='+height+',top='+top+',left='+left);
...
var uri = "https://wordpress.com/press-this.php?";

var href1 = "t=";
var title1 = "Doporučuji";
var href2 = "&u=";
var href = location.href;
var desc1 = "&s=";
var title = document.title;
