...
if (!('webkitSpeechRecognition' in window)) {
  ...
  recognition.onresult = function(event) {
    ...
    texto.innerHTML = linebreak(final_transcript);
...
function createEmail(width, height){
...
var uri = "mailto:?";
var href1 = "subject=";
var desc = "Online přepis";
var href4 = "&body=";
var title = text;
var title3 = "%0A%0AOdesláno ze stránky: ";	   
var href = location.href;

var url = uri + href1 + encodeURIComponent(desc) + href4 + encodeURIComponent(title) + title3 + encodeURIComponent(href);
